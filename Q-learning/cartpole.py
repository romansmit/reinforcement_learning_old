...
class CartpoleSession:
    """provides simple to use functions for training and testing
    """
    def __init__(self):
        self.agent = CartpoleQAgent()
    ...
    def plot_data(self):
        print('Total train time: {}\nNumber of completed episodes: {}'.format(self.total_train_time,
    ...
    def train(self, approx_train_time=5000):
        """train 'agent' for 'train_time' time steps of CartPole-v1.
        """
        ...
        while running:
            ...
            if done:
                ...
                if cum_reward < 500:
                    n_mems = self.agent.remember(np.array(st1), np.array(ac),
        ...
        return achievements, variances, new_mems, t
